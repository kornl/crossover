...
public class StatMethodDialog extends JDialog implements ActionListener {
    ...
    public StatMethodDialog(JFrame owner, String title) {
        this(owner, title, true);
    }

    public StatMethodDialog(JFrame owner, String title, boolean dataSetNeeded) {
        super(owner, title);
        //this.df = analysis.getControl().getDataFrame();

...
RcppExport SEXP searchCOD(SEXP sS, SEXP pS, SEXP vS, SEXP designS, SEXP linkMS, SEXP tCCS, SEXP modelS, SEXP effFactorS, SEXP vRepS, SEXP balanceSS, SEXP balancePS, SEXP verboseS, SEXP nS, SEXP jumpS);

RcppExport SEXP createRCD(SEXP designS, SEXP vS, SEXP modelS);

RcppExport SEXP getInfMatrix(SEXP designS, SEXP vS, SEXP modelS);

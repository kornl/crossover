...
load("pkg/crossover/vignettes/BIBD_6_4_24_5000_1000.RData")
load("pkg/crossover/vignettes/BIBD_6_4_24_50000_100.RData")
load("pkg/crossover/vignettes/BIBD_6_4_24_250000_20.RData")
data(pattersonLucasPBIBD)
pattersonLucasPBIBD134

# This is strange - design.efficiency(result)$av.eff.trt.pair.adj is higher than for pattersonLucasPBIBD134.
design.efficiency(pattersonLucasPBIBD134)$av.eff.trt.pair.adj
design.efficiency(result0)$av.eff.trt.pair.adj
design.efficiency(result)$av.eff.trt.pair.adj
design.efficiency(result2)$av.eff.trt.pair.adj
design.efficiency(result3)$av.eff.trt.pair.adj
